"""This is the script that trains all the models and saves their results."""
...
def make_models(data, model):
    ...
    conn = sqlite3.connect(f'{data}/{data}.sqlite3')
    cur = conn.cursor()

    test = pd.read_csv(f'{data}/{data}_data/{data}_test.csv')
    ...
    '2shot_05_train_ada',
    '2shot_05_train_davinci',
    '3shot_05_train_ada',
    '3shot_05_train_davinci',
    '4shot_05_train_ada',
    '4shot_05_train_davinci',
    '5shot_05_train_ada',
    '5shot_05_train_davinci'
    ]
